        ...
        {active && (
          <>
            <p className="main__text" id="maintext">
              ...
              проще! Мы подготовили подборку книжных подарков, которые выручат даже в самой сложной
              ...
              подарок. С нашим secret santa подготовка к праздникам превратится в радость, а ваши
